	...
	public void printLoad(final String load) {
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				txtinfo[2].setVisible(true); //�ndret fra false
				txtinfo[3].setVisible(true); //�ndret fra false
			}
		});
	}
	public void printBottom(final String msg) {
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				txtinfo[2].setVisible(true); //�ndret fra false
				txtinfo[3].setVisible(true); //�ndret fra false
				userInput.setVisible(false);  //�ndret fra false
	...
	public void printText3(final String msg) {
		Platform.runLater(new Runnable() {
			...
			public void run() {
				...
				txtload.setVisible(true); //�ndret fra false
			}
		});
	}
